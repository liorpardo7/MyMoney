...
export const INSTITUTIONS: InstitutionConfig[] = [
  {
    ...
    selectors: {
      ...
      loginButton: 'button[type="submit"], input[type="submit"], button:contains("Sign In")',
      balanceSelectors: [
  ...
  },
  {
    ...
    selectors: {
      ...
      passwordField: 'input[name="password"], input[type="password"]',
      loginButton: 'button[type="submit"], input[type="submit"], button:contains("Log In")',
      balanceSelectors: [
        'h2[aria-level="2"]',
        '.balance',
        '[data-testid*="balance"]'
  ...
  },
  {
    ...
    selectors: {
      usernameField: 'input[name="username"], input[type="text"]',
      passwordField: 'input[name="password"], input[type="password"]',
      loginButton: 'button[type="submit"], input[type="submit"], button:contains("Secure Sign In")',
      balanceSelectors: [
        '.current-balance',
